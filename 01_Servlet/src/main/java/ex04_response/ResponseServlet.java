...
public class ResponseServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
			응답
			서버가 클라이언트한테 보내는게 응답....이구나....
			1. 서버가 클라이언트로 보내는 것이 응답(Response)이다.
		...
		//2. 응답 스트림 생성(IOException 처리가 필요하다. -> 이미 처리 되어있다.)
		PrintWriter out = response.getWriter();		//printWriter의 출력 메소드 : append(), write()
		...
		out.close();	// 출력 스트림은 close를 꼭 해줘야 된다.
